      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4 d-none img-container-1 text-start">
            ...
            <img
              className="hi-img"
              style={{ width: "90px", marginTop: "-25px" }}
              src={Hi}
              alt="image"
            />
          </div>
          <div className="col-lg-8 text-start">
            ...
            >
              ...
              meet users' needs. My focus on user research and usability ensures
              that each design not only looks great but also delivers an
        ...
        <div
          ...
          data-aos-duration="400"
          data-aos-easing="ease-in-out"
          className="row text-start skills-row"
        >
