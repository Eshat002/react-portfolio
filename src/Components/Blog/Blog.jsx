      ...
      <div className="container">
        <div className="text-start pt-5 pb-3">
          ...
          <p
            ...
            className="sub-headline mt-3"
          >
            Here is the some of recent blog posts about my work and activities.
            Each of them reflects my focus on user-centered design and my
        ...
        >
          ...
          <SwiperSlide>
            ...
            <p
              ...
              className="blog-post"
            >
              Designed a user-friendly travel booking app that enables users to
              effortlessly plan and book their dream vacations.{" "}
            </p>
          </SwiperSlide>
          ...
          <SwiperSlide>
            ...
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Developed an intuitive online streaming app that brings
              entertainment to users' fingertips.{" "}
            </p>
          </SwiperSlide>
