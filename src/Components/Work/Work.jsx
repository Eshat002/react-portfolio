    ...
    return (
        <div id="work-id" className="work mb-3 px-3">
            <div className="container">
                <div className="row mb-4">
                    <div className="col-lg-8 text-start">
                        ...
                        <p style={{ color: purpleMode ? "#fff" : "" }}
                            ...
                            className='sub-headline'>Here's a glimpse of some of my recent and exciting projects. Each of them reflects my focus on user-centered design and my commitment to excellence in user experience.</p>
                    </div>
                ...
                <div className='row'>
                    <a className='text-center see-all-projects' href="">See all projects</a>
                </div>
            </div>
        </div>
    )
